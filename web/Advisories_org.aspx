...
<asp:Content ID="cParentPageLink" ContentPlaceHolderID="cpParentPageLink" Runat="Server">
    <asp:HyperLink ID="lnkParent" runat="server" Text="<%$ Resources:GlobalResources, TechnicalHomeURLText %>" ToolTip="<%$ Resources:GlobalResources, TechnicalHomeURLText %>" NavigateUrl="<%$ Resources:GlobalResources, TechnicalHomeURL %>"></asp:HyperLink>
</asp:Content>
